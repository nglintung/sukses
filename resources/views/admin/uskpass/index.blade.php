...
<div class="content-wrapper">
        ...
        <div class="content-header">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                <h1 class="m-0 text-dark">Daftar Password USK Amikom  <span class="badge badge-pill-sm badge-warning"> {{ $count }} </span>
                </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <form class="d-inline-block" action="{{ route('admin.destroyusk', $setpass->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
...
document.getElementById("reset").addEventListener("click",function(evt){
    ...
    switch (codeEntered) {
        case "7321":
            location.href = "{{ route('admin.resetusk')}}";
            break;
        default:
